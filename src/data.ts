// Header
export const name = "Hannah";
export const occupation = "Web and Software Developer";
export const description = "Passionate driven and eager to showcase my skills and bring ideas to life."
