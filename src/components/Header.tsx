...
function Header(){
    ...
    return (
        <header className="h-dvh bg-[url(assets/Moon.svg)] bg-center bg-no-repeat bg-cover overflow-hidden">
            <div className="w-full h-full bg-gradient-to-b from-white/0 to-black/80 ">
                <div className="grid grid-cols-2 p-20 justify-center items-center gap-40 h-full">
                    <div className="h-full flex justify-center items-center">
                        <div className="p-8 rounded-md bg-[rgba(11,10,20,0.8)]  text-white w-2/3 grid gap-2 backdrop-blur-lg">
