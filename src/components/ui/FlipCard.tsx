...
function FlipCard({ title, description }: FlipCardProps){
    ...
    return (
        <div className={`card-container w-[225px] h-[225px] cursor-pointer`}>
            <div className={`card relative h-full w-full  transform-3d transition duration-500 ease-in-out lg:hover:rotate-y-180 ${isFlipped && "rotate-y-180"} backface-hidden`} 
                onClick={handleFlip}>
